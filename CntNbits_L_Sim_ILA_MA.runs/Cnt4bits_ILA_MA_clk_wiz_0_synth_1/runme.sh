...
HD_PWD='C:/temp/Vivado_WorkSpace/Cnt4bits_ILA_MA/Cnt4bits_ILA_MA.runs/Cnt4bits_ILA_MA_clk_wiz_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Cnt4bits_ILA_MA_clk_wiz_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Cnt4bits_ILA_MA_clk_wiz_0.tcl
