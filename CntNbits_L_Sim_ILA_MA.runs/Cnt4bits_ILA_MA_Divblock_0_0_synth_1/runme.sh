...
HD_PWD='C:/Users/EMELNIAP8/Downloads/CntNbits_L_Sim_ILA_MA/CntNbits_L_Sim_ILA_MA/CntNbits_L_Sim_ILA_MA.runs/Cnt4bits_ILA_MA_Divblock_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Cnt4bits_ILA_MA_Divblock_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Cnt4bits_ILA_MA_Divblock_0_0.tcl
