...
HD_PWD='C:/Users/EMELNIAP8/Downloads/CntNbits_L_Sim_ILA_MA/CntNbits_L_Sim_ILA_MA/CntNbits_L_Sim_ILA_MA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Cnt4bits_ILA_MA_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Cnt4bits_ILA_MA_wrapper.tcl -notrace
