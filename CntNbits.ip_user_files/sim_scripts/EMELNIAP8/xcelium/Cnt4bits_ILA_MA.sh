...
#
# Script generated by Vivado on Sun Jun 22 21:10:15 +0300 2025
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../Users/EMELNIAP8/ipshared/3242" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../../Users/EMELNIAP8/ipshared/3242" \
  ...
  xmvlog -work util_vector_logic_v2_0_4 $xmvlog_opts +incdir+"../../../../../../../Users/EMELNIAP8/ipshared/3242" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/temp/Vivado_WorkSpace/CntNbits/CntNbits.cache/compile_simlib/xcelium"
  fi
