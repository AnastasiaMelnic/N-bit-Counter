...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_15 -L util_vector_logic_v2_0_4 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Cnt4bits_ILA_MA xil_defaultlib.Cnt4bits_ILA_MA xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Cnt4bits_ILA_MA -key {Behavioral:sim_1:Functional:Cnt4bits_ILA_MA} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_95ed.protoinst" -protoinst "protoinst_files/Cnt4bits_ILA_MA.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Cnt4bits_ILA_MA.wdb xsim.dir libdpi.so)
