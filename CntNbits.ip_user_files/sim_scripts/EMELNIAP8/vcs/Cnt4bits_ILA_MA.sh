...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../Users/EMELNIAP8/ipshared/3242" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../Users/EMELNIAP8/ipshared/3242" \
  ...
  vlogan -work util_vector_logic_v2_0_4 $vlogan_opts +v2k +incdir+"../../../../../../../Users/EMELNIAP8/ipshared/3242" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/temp/Vivado_WorkSpace/CntNbits/CntNbits.cache/compile_simlib/vcs"
  fi
